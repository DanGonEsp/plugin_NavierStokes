...
//    PropertiesInterface
	{
		...
		reg.add_class_<T>(name, grp)
			...
			.add_method("set_particle_kinVisc",  &T::set_particle_kinVisc)
			...
			.add_method("set_FrictionMu_1",  &T::set_FrictionMu_1)
			.add_method("set_FrictionMu_2",  &T::set_FrictionMu_2)
...
//    GranularViscosityLinker
	{
		...
		reg.add_class_<T, TBase>(name, grp)
			...
			.add_method("set_gamma_average",  &T::set_gamma_average)
			.add_constructor()
			.set_construct_as_smart_pointer(true);
