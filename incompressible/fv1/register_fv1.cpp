...
static void DomainAlgebra(Registry& reg, string grp)
{
	...
	// ParticlePressureFV1
	{
		string name = string("ParticlePressureFV1").append(suffix);
		typedef ParticlePressureFV1<TFct> T;
		typedef CplUserData<number, dim> TBase;
		typedef INewtonUpdate TBase2;
		reg.add_class_<T, TBase,TBase2>(name, grp)
			.template add_constructor<void (*)(SmartPtr<ApproximationSpace<TDomain> >,SmartPtr<TFct>)>("Approximation space, grid function")
				...
				.add_method("update", &T::update)
		.set_construct_as_smart_pointer(true);
		reg.add_class_to_group(name, "ParticlePressureFV1", tag);
	}
	// MeanNormal
	{
		...
		reg.add_class_<T, TBase,TBase2>(name, grp)
			.template add_constructor<void (*)(SmartPtr<ApproximationSpace<TDomain> >,SmartPtr<TFct>)>("Approximation space, grid function")
				.add_method("set_normal", static_cast<void (T::*)(SmartPtr<CplUserData<MathVector<dim>, dim> >)>(&T::set_normal), "", "Normal")
				.add_method("set_normal", static_cast<void (T::*)(number)>(&T::set_normal), "", "N_x")
				.add_method("set_normal", static_cast<void (T::*)(number,number)>(&T::set_normal), "", "N_x, N_y")
				.add_method("set_normal", static_cast<void (T::*)(number,number,number)>(&T::set_normal), "", "N_x, N_y, N_z")
			#ifdef UG_FOR_LUA
				.add_method("set_normal", static_cast<void (T::*)(const char*)>(&T::set_normal), "", "Normal Vector")
			#endif
				...
				.add_method("set_slope_limit", static_cast<void (T::*)(number)>(&T::set_slope_limit), "", "SlopeLimit")
	...
	// Diffusion
	{
		string name = string("SlipDiffusion").append(suffix);
		typedef SlipDiffusion<TFct> T;
	...
	// MeanNormal
	{
		...
		reg.add_class_<T, TBase,TBase2>(name, grp)
			.template add_constructor<void (*)(SmartPtr<ApproximationSpace<TDomain> >,SmartPtr<TFct>)>("Approximation space, grid function")
				...
				.add_method("set_omega", static_cast<void (T::*)(number)>(&T::set_omega), "", "DampingFactor")
				.add_method("set_phase_parameters", &T::set_phase_parameters)
				.add_method("update", &T::update)
		.set_construct_as_smart_pointer(true);
...
static void Domain(Registry& reg, string grp)
{
    ...
    //    Navier-Stokes FV1M
    {
        ...
        reg.add_class_<T, TBase >(name, grp)
			...
			.add_method("set_density", static_cast<void (T::*)(SmartPtr<CplUserData<number, dim> >,bool)>(&T::set_density), "", "Density Linerized Def")
            .add_method("set_pac_upwind", &T::set_pac_upwind, "", "Set pac upwind")
			...
			.add_method("set_mass_mean", &T::set_mass_mean)
            .set_construct_as_smart_pointer(true);
