...
SmartPtr<INavierStokesSRFV1StabilizationM<dim> > CreateNavierStokesStabilizationM(const std::string& name)
{
    ...
    if(n == "fields") return SmartPtr<NavierStokesFIELDSStabilizationM<dim> >(new NavierStokesFIELDSStabilizationM<dim>());
    if(n == "flow") return SmartPtr<NavierStokesFLOWStabilizationM<dim> >(new NavierStokesFLOWStabilizationM<dim>());
    if(n == "fields_2") return SmartPtr<NavierStokesFIELDS_2_StabilizationM<dim> >(new NavierStokesFIELDS_2_StabilizationM<dim>());
    if(n == "flow_2") return SmartPtr<NavierStokesFLOW_2_StabilizationM<dim> >(new NavierStokesFLOW_2_StabilizationM<dim>());
    if(n == "karimian") return SmartPtr<NavierStokesKARIMIANStabilizationM<dim> >(new NavierStokesKARIMIANStabilizationM<dim>());
    if(n == "no") return SmartPtr<NavierStokesNOStabilizationM<dim> >(new NavierStokesNOStabilizationM<dim>());
...
void
INavierStokesFV1StabilizationM<dim>::
...
template <int dim>
void
INavierStokesSRFV1StabilizationM<dim>::
...
void
NavierStokesFIELDSStabilizationM<TDim>::
...
template <>
void NavierStokesFIELDSStabilizationM<1>::register_func()
{
    register_func<RegularEdge>();
}

template <>
void NavierStokesFIELDSStabilizationM<2>::register_func()
{
    register_func<RegularEdge>();
...
template <>
void NavierStokesFIELDSStabilizationM<3>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <typename TElem>
void
NavierStokesFLOWStabilizationM<TDim>::
update(const FV1Geometry<TElem, dim>* geo,
       const LocalVector& vCornerValue,
       const MathVector<dim> vStdVel[],
       const bool bStokes,
...
template <>
void NavierStokesFLOWStabilizationM<1>::register_func()
{
    register_func<RegularEdge>();
}

template <>
void NavierStokesFLOWStabilizationM<2>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <>
void NavierStokesFLOWStabilizationM<3>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <typename TElem>
void
NavierStokesFLOW_2_StabilizationM<TDim>::
update(const FV1Geometry<TElem, dim>* geo,
       const LocalVector& vCornerValue,
       const MathVector<dim> vStdVel[],
       const bool bStokes,
...
template <>
void NavierStokesFLOW_2_StabilizationM<1>::register_func()
{
    register_func<RegularEdge>();
}

template <>
void NavierStokesFLOW_2_StabilizationM<2>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <>
void NavierStokesFLOW_2_StabilizationM<3>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <typename TElem>
void
NavierStokesFIELDS_2_StabilizationM<TDim>::
update(const FV1Geometry<TElem, dim>* geo,
	   const LocalVector& vCornerValue,
	   const MathVector<dim> vStdVel[],
	   const bool bStokes,
...
template <>
void NavierStokesFIELDS_2_StabilizationM<1>::register_func()
{
	register_func<RegularEdge>();
}

template <>
void NavierStokesFIELDS_2_StabilizationM<2>::register_func()
{
	register_func<RegularEdge>();
	register_func<Triangle>();
	register_func<Quadrilateral>();
...
template <>
void NavierStokesFIELDS_2_StabilizationM<3>::register_func()
{
	register_func<RegularEdge>();
	register_func<Triangle>();
	register_func<Quadrilateral>();
...
template <typename TElem>
void
NavierStokesKARIMIANStabilizationM<TDim>::
update(const FV1Geometry<TElem, dim>* geo,
       const LocalVector& vCornerValue,
       const MathVector<dim> vStdVel[],
       const bool bStokes,
...
template <>
void NavierStokesKARIMIANStabilizationM<1>::register_func()
{
    register_func<RegularEdge>();
}

template <>
void NavierStokesKARIMIANStabilizationM<2>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <>
void NavierStokesKARIMIANStabilizationM<3>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <typename TElem>
void
NavierStokesNOStabilizationM<TDim>::
update(const FV1Geometry<TElem, dim>* geo,
       const LocalVector& vCornerValue,
       const MathVector<dim> vStdVel[],
       const bool bStokes,
...
template <>
void NavierStokesNOStabilizationM<1>::register_func()
{
    register_func<RegularEdge>();
}

template <>
void NavierStokesNOStabilizationM<2>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <>
void NavierStokesNOStabilizationM<3>::register_func()
{
    register_func<RegularEdge>();
    register_func<Triangle>();
    register_func<Quadrilateral>();
...
template <typename TElem>
void
NavierStokesFV1WithoutStabilizationM<TDim>::
update(const FV1Geometry<TElem, dim>* geo,
       const LocalVector& vCornerValue,
       const MathVector<dim> vStdVel[],
       const bool bStokes,
...
template <>
void NavierStokesFV1WithoutStabilizationM<1>::register_func()
{
	register_func<RegularEdge>();
}

template <>
void NavierStokesFV1WithoutStabilizationM<2>::register_func()
{
	register_func<RegularEdge>();
	register_func<Triangle>();
	register_func<Quadrilateral>();
...
template <>
void NavierStokesFV1WithoutStabilizationM<3>::register_func()
{
	register_func<RegularEdge>();
	register_func<Triangle>();
	register_func<Quadrilateral>();
...
/*#ifdef UG_DIM_1
template class INavierStokesFV1StabilizationM<1>;
template class NavierStokesFIELDSStabilizationM<1>;
template class NavierStokesFLOWStabilizationM<1>;

template SmartPtr<INavierStokesFV1StabilizationM<1> >CreateNavierStokesStabilizationM<1>(const std::string& name);
#endif*/
#ifdef UG_DIM_2
template class INavierStokesFV1StabilizationM<2>;
template class INavierStokesSRFV1StabilizationM<2>;
template class NavierStokesFIELDSStabilizationM<2>;
template class NavierStokesFLOWStabilizationM<2>;
template class NavierStokesFIELDS_2_StabilizationM<2>;
template class NavierStokesFLOW_2_StabilizationM<2>;
template class NavierStokesKARIMIANStabilizationM<2>;

template SmartPtr<INavierStokesSRFV1StabilizationM<2> >CreateNavierStokesStabilizationM<2>(const std::string& name);
#endif
#ifdef UG_DIM_3
template class INavierStokesFV1StabilizationM<3>;
template class INavierStokesSRFV1StabilizationM<3>;
template class NavierStokesFIELDSStabilizationM<3>;
template class NavierStokesFLOWStabilizationM<3>;
template class NavierStokesFIELDS_2_StabilizationM<3>;
template class NavierStokesFLOW_2_StabilizationM<3>;
template class NavierStokesKARIMIANStabilizationM<3>;

template SmartPtr<INavierStokesSRFV1StabilizationM<3> >CreateNavierStokesStabilizationM<3>(const std::string& name);
#endif
