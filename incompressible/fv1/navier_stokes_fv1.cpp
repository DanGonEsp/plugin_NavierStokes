...
add_jac_A_elem(LocalMatrix& J, const LocalVector& u, GridObject* elem, const MathVector<dim> vCornerCoords[])
{
	...
	m_spStab->update(&geo, *pSol, StdVel, m_bStokes, m_imKinViscosity, m_imKinViscositySCV, m_imDensitySCVF, NULL, m_imDensitySCV, NULL, NULL, NULL, NULL, m_imSourceSCVF, m_imSourceSCV, NULL, pOldSol, dt, NULL, NULL, false);
    ...
    if (! m_bStokes) // no convective terms in the Stokes eq. => no upwinding
    {
        ...
        if(m_spConvStab.valid())
            if(m_spConvStab != m_spStab)
                m_spConvStab->update(&geo, *pSol, StdVel, false, m_imKinViscosity, m_imKinViscositySCV, m_imDensitySCVF, NULL, m_imDensitySCV, NULL, NULL, NULL, NULL, m_imSourceSCVF, m_imSourceSCV, NULL, pOldSol, dt, NULL, NULL, false);
    }
